 ...
 * {@link #update()}).
 */
public abstract class ActiveRouterEnergy extends MessageRouter {
	 ...
	 */
	public ActiveRouterEnergy(Settings s) {
		super(s);
		...
		if (s.contains(EnergyModel.INIT_ENERGY_S)) {
			...
			throw new RuntimeException("Parameters for energy model not provided!");
		}
	}
	 ...
	 */
	protected ActiveRouterEnergy(ActiveRouterEnergy r) {
		super(r);
	...
	/**
	 * Returns the current energy status of the node.
	 */
	public double getEnergy() {
		return this.energy.getEnergy();
	}

	// public void setEnergyModel(Settings s) {
	// 	if (s.contains(EnergyModel.INIT_ENERGY_S)) {
	// 		this.energy = new EnergyModel(s);
	// 	} else {
	// 		throw new RuntimeException("Parameters for energy model not provided!");
